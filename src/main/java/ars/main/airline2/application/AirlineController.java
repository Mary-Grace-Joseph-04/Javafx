...
import ars.main.airline2.HelloApplication;
...
public class AirlineController implements Initializable {
    ...
    public static void changeScene() throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("airline.fxml"));
